...
void jsonNodeToXml(const boost::property_tree::ptree& jsonNode, boost::property_tree::ptree& xmlNode,
									 const std::string nsPrefix = "", ElementsProcessor processor = DefaultProcessor);
