...
namespace osrv
{
	...
	{
		requestHandlers_.push_back(std::make_shared<GetAnalyticsConfigurationsHandler>(xml_namespaces_, configs_ptree_));
		requestHandlers_.push_back(std::make_shared<GetAudioEncoderConfigurationsHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig()));
		...
		requestHandlers_.push_back(std::make_shared<GetProfilesHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig(), *srv->ServerConfigs()));
		requestHandlers_.push_back(std::make_shared<GetVideoEncoderConfigurationsHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig()));
		requestHandlers_.push_back(std::make_shared<GetVideoEncoderConfigurationOptionsHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig()));
		requestHandlers_.push_back(std::make_shared<GetVideoSourceConfigurationsHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig(), *srv->ServerConfigs()));
		requestHandlers_.push_back(std::make_shared<GetVideoSourceConfigurationOptionsHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig()));
		requestHandlers_.push_back(std::make_shared<GetServiceCapabilitiesHandler>(xml_namespaces_, configs_ptree_));
		requestHandlers_.push_back(std::make_shared<GetStreamUriHandler>(xml_namespaces_, configs_ptree_, srv->ProfilesConfig(), *srv->ServerConfigs()));
		requestHandlers_.push_back(std::make_shared<SetVideoEncoderConfigurationHandler>(xml_namespaces_, configs_ptree_));
		requestHandlers_.push_back(std::make_shared<SetVideoSourceConfigurationHandler>(xml_namespaces_, configs_ptree_));
	}
}
