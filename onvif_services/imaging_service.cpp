...
void do_handle_request(std::shared_ptr<HttpServer::Response> response, std::shared_ptr<HttpServer::Request> request);
...
ImagingService::ImagingService(const std::string& service_uri, const std::string& service_name,
